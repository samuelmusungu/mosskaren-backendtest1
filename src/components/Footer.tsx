        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm opacity-80 leading-relaxed">
              Experience exceptional dining in the heart of Karen Plains. 
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 mt-6">
              <a href="#menu" className="block text-sm hover:text-primary transition-colors">
                Menu
              </a>
              <a href="#reservations" className="block text-sm hover:text-primary transition-colors">
                Reservations
              </a>
              <a href="#location" className="block text-sm hover:text-primary transition-colors">
                Location
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="hover:text-primary transition-colors opacity-80">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-primary transition-colors opacity-80">
                Terms of Service
